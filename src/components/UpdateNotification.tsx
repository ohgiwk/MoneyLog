...
export default function UpdateNotification() {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-surface rounded-2xl px-6 py-5 mx-4 w-full max-w-xs shadow-xl">
        ...
        <div className="flex gap-3">
          <button
            ...
            className="flex-1 py-2.5 rounded-xl border border-line text-ink-muted text-sm active:bg-surface-subtle"
          >
            あとで
          </button>
          <button
