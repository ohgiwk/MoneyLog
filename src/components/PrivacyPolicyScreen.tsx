...
const sections = [
  {
    title: '1. はじめに',
    content:
      'キンカク手帖（以下「本アプリ」）は、ユーザーのプライバシーを尊重し、個人情報を適切に管理することをお約束します。本ポリシーは、本アプリが収集する情報、その利用方法、およびユーザーの権利について説明します。',
  },
  {
    title: '2. 収集する情報',
  ...
  },
  {
    title: '4. 第三者への提供',
    content:
      '本アプリは、法令に基づく場合を除き、ユーザーの個人情報を第三者に販売・貸与・開示しません。なお、本アプリはバックエンドとして Supabase を利用しており、データはそのサービス上に保存されます。',
  },
  {
    title: '5. データの保存と安全性',
    content:
      'ユーザーデータは Supabase のセキュアなクラウド環境に保存されます。Row Level Security（行レベルセキュリティ）により、各ユーザーは自分のデータにのみアクセスできます。',
  },
  {
    title: '6. データの削除',
    content:
      'アカウントおよびすべての関連データの削除をご希望の場合は、マイページの「アカウントを削除する」からお手続きいただけます。',
  },
  {
    title: '7. ポリシーの変更',
    content:
