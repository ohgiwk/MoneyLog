...
const sections = [
  {
    title: '1. 総則',
    content:
      '本利用規約（以下「本規約」）は、キンカク手帖（以下「本アプリ」）の利用条件を定めるものです。ユーザーは本規約に同意した上で本アプリをご利用ください。',
  },
  {
    title: '2. 利用資格',
    content:
      '本アプリは、有効なメールアドレスを持ち、本規約に同意したユーザーがご利用いただけます。13歳未満の方のご利用はお断りしております。',
  },
  {
    title: '3. アカウント',
    content:
      'ユーザーはアカウントの認証情報を安全に管理する責任を負います。アカウントの不正使用が発覚した場合は、速やかにご連絡ください。',
  },
  {
    title: '4. 禁止事項',
    content: '以下の行為を禁止します。',
  ...
  },
  {
    title: '5. データの取り扱い',
    content:
      'ユーザーが本アプリに入力したデータはユーザー本人に帰属します。本アプリの利用を通じて生じたデータの損失について、開発者は責任を負いません。定期的なエクスポート等によるバックアップを推奨します。',
  },
  {
    title: '6. 免責事項',
    content:
      '本アプリは家計管理の補助ツールであり、提供する情報は参考目的に限ります。本アプリの利用に起因して生じた損害について、開発者は一切の責任を負いません。',
  },
  {
    title: '7. サービスの変更・終了',
    content:
      '開発者は予告なく本アプリの機能変更・サービス終了を行う場合があります。重大な変更がある場合はアプリ内でお知らせします。',
  },
  {
    title: '8. 規約の変更',
    content:
      '本規約は必要に応じて改定することがあります。改定後も本アプリをご利用いただいた場合、新しい規約に同意したものとみなします。',
  },
  {
    title: '9. 準拠法',
    content:
      '本規約は日本法を準拠法とし、本アプリに関する紛争は日本の裁判所を専属的合意管轄とします。',
  },
]
